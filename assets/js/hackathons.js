...
function init() {
  ...
  function showInfo(data) {
    ...
    while (data[index] != null) {
      ...
      alert("projectsContent: " + projectsContent)
      alert("awardsContent: " + awardsContent)
      htmlContent = htmlContent + projectsContent + awardsContent;
      // htmlContent = htmlContent.substring(htmlContent.lastIndexOf("Project(s)"), htmlContent.length);
      htmlContent += '<br><br>'
      index++;
      htmlContent += '</ol></div>';
    }
